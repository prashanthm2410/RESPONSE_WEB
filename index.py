...
model = joblib.load('D:/Projects/prod_price_pred/models/xgboost_model.pkl')
vectorizer = joblib.load('D:/Projects/prod_price_pred/models/tfidf_vectorizer_product_rating_xgb.pkl')
